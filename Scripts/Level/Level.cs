...
namespace PartyBall.Scripts.Level
{
    public class Level
    {
        ...
        public void LoadContent(Game game)
        {
            ...
            //var wallScale = 0.25f;
            //var regPlatform_1 = new Pipe(Graphics.Reg_Platform, Vector2.Zero, platformScale);
            //var regPlatform_2 = new Pipe(Graphics.Reg_Platform, Vector2.Zero, platformScale);
